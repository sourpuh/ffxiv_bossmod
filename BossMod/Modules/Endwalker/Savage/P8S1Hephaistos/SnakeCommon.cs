...
namespace BossMod.Endwalker.Savage.P8S1Hephaistos
{
    ...
    abstract class PetrifactionCommon : Components.GenericGaze
    {
        ...
        public void DrawPetrify(Actor source, bool delayed, IArena arena) => arena.AddCone(source.Position, 25, source.Rotation, 45.Degrees(), delayed ? ArenaColor.Safe : ArenaColor.Danger);
        public void DrawExplode(Actor source, bool delayed, IArena arena) => arena.AddCircle(source.Position, 5, delayed ? ArenaColor.Safe : ArenaColor.Danger);
    }
}
